 ...
 * Params: 
 *   wParam - line number
 *   lParam - SEDIT_LINE or SEDIT_REALLINE
 * Returns:
 *   length of the line
 */
 ...
 * Params:
 *   LOWORD(wParam) - SEDIT_LINE or SEDIT_REALLINE
...
// Constants which represents lines (SEDIT_LINE) and paragraphs (SEDIT_REALLINE).
...
#define SEDIT_LINEBREAK_CRLF  0
#define SEDIT_LINEBREAK_CR    1
#define SEDIT_LINEBREAK_LF    2
...
typedef struct tag_options_t
{
  ...
  char useRegexp;                   // 0/1
  char lineBreakType;               // SEDIT_LINEBREAK_CRLF / SEDIT_LINEBREAK_CR / SEDIT_LINEBREAK_LF
